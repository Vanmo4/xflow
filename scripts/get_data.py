...
os.environ["MLFLOW_REGISTRY_URI"] = "/home/ivan/Git/MLOps_HW_3S/xflow/mlflow/"
mlflow.set_tracking_uri("http://localhost:5000")
mlflow.set_experiment("get_data_1")

# Инициализация объекта API, Youtube
key = "AIzaSyAIzT7X4rVoCEhYdE2Oaf_8-TDsz3eLjtU"
api = Api(api_key=key)
...
with mlflow.start_run():
    ...
    mlflow.log_artifact(local_path="/home/ivan/Git/MLOps_HW_3S/xflow/scripts/get_data.py",
                        artifact_path="get_data code")
    mlflow.end_run()

with open('/home/ivan/Git/MLOps_HW_3S/xflow/datasets/data.csv', 'a') as f:
    f.write("{}\n".format(s))
